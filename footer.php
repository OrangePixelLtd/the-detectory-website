        ...
        <div class="footer-grid">
            <div class="footer-about">
                ...
                <div class="store-buttons store-buttons--sm">
                    <a href="#" class="store-btn store-btn--dark store-btn--sm" aria-label="Download on the App Store">
                    ...
                    <a href="#" class="store-btn store-btn--dark store-btn--sm" aria-label="Get it on Google Play">
